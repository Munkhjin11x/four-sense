    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Badge variant="outline" className="font-medium">
          ...
          {Tables[row.original.tableName as keyof typeof Tables] ? Tables[row.original.tableName as keyof typeof Tables] : row.original.tableName}
        </Badge>
      ),
    },
    {
