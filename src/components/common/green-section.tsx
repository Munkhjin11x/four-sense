        ...
        <div className=" w-full flex flex-col gap-6 items-center justify-center">
          <div className=" relative flex justify-center  z-50 w-full">
            <video
              ...
              muted
            >
              <source src={CDN_URL + "/home/intro.mp4"} type="video/mp4" />
            ...
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute -z-10  w-full max-w-[1300px] top-1/2 max-sm:left-[39%] left-[41%] items-center flex justify-center -translate-x-1/2 -translate-y-1/2 ">
              <Image
