...
var BuildId = "nLvGsaU9WxtiyLWQjCx4s";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/api/admin/login/route": "/api/admin/login", "/api/order/route": "/api/order", "/api/signup/route": "/api/signup", "/api/tables/route": "/api/tables", "/api/table/update-table-seat-status/route": "/api/table/update-table-seat-status", "/favicon.ico/route": "/favicon.ico", "/api/create-example-data/route": "/api/create-example-data", "/_not-found/page": "/_not-found", "/(home)/book-table/page": "/book-table", "/(home)/bar-menu/page": "/bar-menu", "/(home)/page": "/", "/admin/login/page": "/admin/login", "/admin/dashboard/page": "/admin/dashboard" };
