...
var BuildId = "LyZkRKrRfExjAtUO0uZec";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/api/admin/login/route": "/api/admin/login", "/api/order/route": "/api/order", "/api/tables/route": "/api/tables", "/favicon.ico/route": "/favicon.ico", "/api/table/update-table-seat-status/route": "/api/table/update-table-seat-status", "/api/create-example-data/route": "/api/create-example-data", "/api/signup/route": "/api/signup", "/_not-found/page": "/_not-found", "/(home)/page": "/", "/(home)/book-table/page": "/book-table", "/(home)/bar-menu/page": "/bar-menu", "/admin/login/page": "/admin/login", "/admin/dashboard/page": "/admin/dashboard" };
