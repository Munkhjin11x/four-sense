...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/login/route": "/api/admin/login", "/api/create-example-data/route": "/api/create-example-data", "/favicon.ico/route": "/favicon.ico", "/api/signup/route": "/api/signup", "/api/table/update-table-seat-status/route": "/api/table/update-table-seat-status", "/api/order/route": "/api/order", "/api/tables/route": "/api/tables", "/admin/dashboard/page": "/admin/dashboard", "/admin/login/page": "/admin/login", "/(home)/bar-menu/page": "/bar-menu", "/(home)/book-table/page": "/book-table", "/(home)/page": "/" };
