...
var BuildId = "E4Vh6NFfkUzEdK-ENZPMP";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/login/route": "/api/admin/login", "/api/cancel-order/route": "/api/cancel-order", "/api/approve-order/route": "/api/approve-order", "/api/table/update-table-seat-status/route": "/api/table/update-table-seat-status", "/api/create-example-data/route": "/api/create-example-data", "/favicon.ico/route": "/favicon.ico", "/api/order/route": "/api/order", "/api/signup/route": "/api/signup", "/api/tables/route": "/api/tables", "/(home)/page": "/", "/admin/dashboard/page": "/admin/dashboard", "/(home)/book-table/page": "/book-table", "/(home)/bar-menu/page": "/bar-menu", "/admin/login/page": "/admin/login" };
